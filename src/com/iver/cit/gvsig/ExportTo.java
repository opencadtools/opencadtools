...
public class ExportTo extends Extension {
	...
	try {
	    ...
	    // Fjp:
	    // Cambio: En Postgis, el nombre de catálogo está siempre vacío. Es
	    // algo heredado de Oracle, que no se usa.
	    // dbLayerDef.setCatalogName(cs.getDb());
	    dbLayerDef.setCatalogName("");

	    // Añadimos el schema dentro del layer definition para poder tenerlo
	    // en cuenta.
    ...
    protected IndexedShpDriver getOpenShpDriver(File fileShp)
