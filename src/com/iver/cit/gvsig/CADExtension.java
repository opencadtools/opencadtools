...
public class CADExtension extends Extension implements IPreferenceExtension {
    private static HashMap<IProjectView, CADToolAdapter> adapters = new HashMap<IProjectView, CADToolAdapter>();
	...
	public boolean postProcessKeyEvent(KeyEvent e) {
	    ...
	    // removed this line because all keys we want to process seems to
	    // come from JEditTextArea...
	    // but it's better to keep it commented just in case it is necessary
	    // to get an event from other component...
