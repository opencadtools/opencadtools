...
public class GridPage extends AbstractPreferencePage {
	...
	chkShowGrid = new JCheckBox(PluginServices.getText(this,
		"mostrar_rejilla"));
	addComponent(chkShowGrid);
	chkAdjustGrid = new JCheckBox(PluginServices.getText(this,
		"ajustar_rejilla"));
	...
	// boolean showGrid =
	// prefs.getBoolean("grid.showgrid",cta.getGrid().isShowGrid());
	// boolean adjustGrid =
	// prefs.getBoolean("grid.adjustgrid",cta.getGrid().isAdjustGrid());
	//
	// double dx =
	// prefs.getDouble("grid.distancex",cta.getGrid().getGridSizeX());
	// double dy =
	// prefs.getDouble("grid.distancey",cta.getGrid().getGridSizeY());
