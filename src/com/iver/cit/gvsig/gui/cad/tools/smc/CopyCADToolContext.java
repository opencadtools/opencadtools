...
public final class CopyCADToolContext extends statemap.FSMContext {
    // ---------------------------------------------------------------
    // Member methods.
    //
    ...
    public CopyCADToolState getState() throws statemap.StateUndefinedException {
	if (_state == null) {
    ...
    public static abstract class CopyCADToolState extends statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addPoint(CopyCADToolContext context, double pointX,
	...
	static {
	    FirstPointToMove = new Copy_Default.Copy_FirstPointToMove(
		    "Copy.FirstPointToMove", 0);
	    SecondPointToMove = new Copy_Default.Copy_SecondPointToMove(
		    "Copy.SecondPointToMove", 1);
	...
	protected void addOption(CopyCADToolContext context, String s) {
		...
		boolean loopbackFlag = context.getState().getName()
			.equals(Copy.FirstPointToMove.getName());
