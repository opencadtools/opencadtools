...
public final class LineCADToolContext extends statemap.FSMContext {
    // ---------------------------------------------------------------
    // Member methods.
    //
    ...
    public LineCADToolState getState() throws statemap.StateUndefinedException {
	if (_state == null) {
    ...
    public static abstract class LineCADToolState extends statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addPoint(LineCADToolContext context, double pointX,
	...
	static {
	    ...
	    SecondPointOrAngle = new Line_Default.Line_SecondPointOrAngle(
		    "Line.SecondPointOrAngle", 1);
	    LenghtOrPoint = new Line_Default.Line_LenghtOrPoint(
		    "Line.LenghtOrPoint", 2);
	...
	protected void addOption(LineCADToolContext context, String s) {
		...
		boolean loopbackFlag = context.getState().getName()
			.equals(Line.FirstPoint.getName());
