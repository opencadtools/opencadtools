...
public final class PolygonCADToolContext extends statemap.FSMContext {
    // ---------------------------------------------------------------
    // Member methods.
    //
    ...
    public static abstract class PolygonCADToolState extends statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addPoint(PolygonCADToolContext context, double pointX,
	...
	static {
	    NumberOrCenterPoint = new Polygon_Default.Polygon_NumberOrCenterPoint(
		    "Polygon.NumberOrCenterPoint", 0);
	    CenterPoint = new Polygon_Default.Polygon_CenterPoint(
		    "Polygon.CenterPoint", 1);
	    OptionOrRadiusOrPoint = new Polygon_Default.Polygon_OptionOrRadiusOrPoint(
		    "Polygon.OptionOrRadiusOrPoint", 2);
	    RadiusOrPoint = new Polygon_Default.Polygon_RadiusOrPoint(
		    "Polygon.RadiusOrPoint", 3);
	...
	protected void addOption(PolygonCADToolContext context, String s) {
		...
		boolean loopbackFlag = context.getState().getName()
			.equals(Polygon.NumberOrCenterPoint.getName());
	...
	private static final class Polygon_NumberOrCenterPoint extends
		Polygon_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
	    ...
	    @Override
	    protected void addPoint(PolygonCADToolContext context,
		...
		try {
		    ...
		    ctxt.setDescription(new String[] { "into_circle",
			    "circumscribed", "cancel" });
		...
		if (d < 3) {
		    ...
		    context.clearState();
		    try {
			ctxt.throwValueException(PluginServices.getText(this,
				"num_lados_insuficiente"), d);
		    } finally {
	...
	private static final class Polygon_OptionOrRadiusOrPoint extends
		Polygon_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
	...
	private static final class Polygon_RadiusOrPoint extends
		Polygon_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
