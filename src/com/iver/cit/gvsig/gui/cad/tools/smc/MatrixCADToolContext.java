...
public final class MatrixCADToolContext extends statemap.FSMContext {
    // ---------------------------------------------------------------
    // Member methods.
    //
    ...
    public static abstract class MatrixCADToolState extends statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addPoint(MatrixCADToolContext context, double pointX,
	...
	static {
	    ...
	    FirstPoint = new Matrix_Default.Matrix_FirstPoint(
		    "Matrix.FirstPoint", 1);
	    SecondPoint = new Matrix_Default.Matrix_SecondPoint(
		    "Matrix.SecondPoint", 2);
	...
	private static final class Matrix_Start extends Matrix_Default {
	    ...
	    @Override
	    protected void addPoint(MatrixCADToolContext context,
