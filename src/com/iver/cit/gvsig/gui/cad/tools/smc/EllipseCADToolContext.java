...
public final class EllipseCADToolContext extends statemap.FSMContext {
    // ---------------------------------------------------------------
    // Member methods.
    //
    ...
    public static abstract class EllipseCADToolState extends statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addPoint(EllipseCADToolContext context, double pointX,
	...
	static {
	    FirstPointAxis = new Ellipse_Default.Ellipse_FirstPointAxis(
		    "Ellipse.FirstPointAxis", 0);
	    SecondPointAxis = new Ellipse_Default.Ellipse_SecondPointAxis(
		    "Ellipse.SecondPointAxis", 1);
	    DistanceOtherAxis = new Ellipse_Default.Ellipse_DistanceOtherAxis(
		    "Ellipse.DistanceOtherAxis", 2);
	...
	protected void addOption(EllipseCADToolContext context, String s) {
		...
		boolean loopbackFlag = context.getState().getName()
			.equals(Ellipse.FirstPointAxis.getName());
	...
	private static final class Ellipse_FirstPointAxis extends
		Ellipse_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
	    ...
	    @Override
	    protected void addPoint(EllipseCADToolContext context,
	...
	private static final class Ellipse_SecondPointAxis extends
		Ellipse_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
	...
	private static final class Ellipse_DistanceOtherAxis extends
		Ellipse_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
