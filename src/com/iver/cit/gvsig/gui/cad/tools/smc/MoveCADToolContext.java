...
public final class MoveCADToolContext extends statemap.FSMContext {
    // ---------------------------------------------------------------
    // Member methods.
    //
    ...
    public MoveCADToolState getState() throws statemap.StateUndefinedException {
	if (_state == null) {
    ...
    public static abstract class MoveCADToolState extends statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addPoint(MoveCADToolContext context, double pointX,
	...
	static {
	    FirstPointToMove = new Move_Default.Move_FirstPointToMove(
		    "Move.FirstPointToMove", 0);
	    SecondPointToMove = new Move_Default.Move_SecondPointToMove(
		    "Move.SecondPointToMove", 1);
	...
	protected void addOption(MoveCADToolContext context, String s) {
		...
		boolean loopbackFlag = context.getState().getName()
			.equals(Move.FirstPointToMove.getName());
