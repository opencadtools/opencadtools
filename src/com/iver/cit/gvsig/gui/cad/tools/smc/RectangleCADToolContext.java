...
public final class RectangleCADToolContext extends statemap.FSMContext {
    // ---------------------------------------------------------------
    // Member methods.
    //
    ...
    public static abstract class RectangleCADToolState extends statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addPoint(RectangleCADToolContext context, double pointX,
	...
	static {
	    FirstPoint = new Rectangle_Default.Rectangle_FirstPoint(
		    "Rectangle.FirstPoint", 0);
	    SecondPointOrSquare = new Rectangle_Default.Rectangle_SecondPointOrSquare(
		    "Rectangle.SecondPointOrSquare", 1);
	    SecondPointSquare = new Rectangle_Default.Rectangle_SecondPointSquare(
		    "Rectangle.SecondPointSquare", 2);
	...
	protected void addOption(RectangleCADToolContext context, String s) {
		...
		boolean loopbackFlag = context.getState().getName()
			.equals(Rectangle.FirstPoint.getName());
	...
	private static final class Rectangle_FirstPoint extends
		Rectangle_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
	    ...
	    @Override
	    protected void addPoint(RectangleCADToolContext context,
	...
	private static final class Rectangle_SecondPointOrSquare extends
		Rectangle_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
		...
		if (s.equalsIgnoreCase(PluginServices.getText(this,
			"RectangleCADTool.square"))
			|| s.equals(PluginServices.getText(this, "square"))) {
	...
	private static final class Rectangle_SecondPointSquare extends
		Rectangle_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
