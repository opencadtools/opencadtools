 ...
 */
public final class RedigitalizePolygonCADToolContext
...
//	Inner classes.
	...
	public static abstract class RedigitalizePolygonCADToolState
	extends statemap.State
	{
		...
		protected void removePoint(RedigitalizePolygonCADToolContext context, InputEvent event, int numPoints)
		{
			Default(context);
		}
	...
	/* package */ static abstract class RedigitalizePolygon
	{
		...
		static
		{
			FirstPoint = new RedigitalizePolygon_Default.RedigitalizePolygon_FirstPoint("RedigitalizePolygon.FirstPoint", 0);
			SecondPoint = new RedigitalizePolygon_Default.RedigitalizePolygon_SecondPoint("RedigitalizePolygon.SecondPoint", 1);
			NextPoint = new RedigitalizePolygon_Default.RedigitalizePolygon_NextPoint("RedigitalizePolygon.NextPoint", 2);
			Default = new RedigitalizePolygon_Default("RedigitalizePolygon.Default", -1);
		}

	}

	protected static class RedigitalizePolygon_Default
	extends RedigitalizePolygonCADToolState
	{
		//-----------------------------------------------------------
		// Member methods.
		//
		...
		protected void addPoint(RedigitalizePolygonCADToolContext context, double pointX, double pointY, InputEvent event)
		{
			...
			boolean loopbackFlag =
				context.getState().getName().equals(
						RedigitalizePolygon.FirstPoint.getName());
		...
		private static final class RedigitalizePolygon_FirstPoint
		extends RedigitalizePolygon_Default
		{
			//-------------------------------------------------------
			// Member methods.
			//
		...
		private static final class RedigitalizePolygon_SecondPoint
		extends RedigitalizePolygon_Default
		{
			//-------------------------------------------------------
			// Member methods.
		...
		private static final class RedigitalizePolygon_NextPoint
		extends RedigitalizePolygon_Default
		{
			//-------------------------------------------------------
			// Member methods.
