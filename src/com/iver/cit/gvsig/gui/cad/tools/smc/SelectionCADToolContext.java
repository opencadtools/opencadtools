...
public final class SelectionCADToolContext extends statemap.FSMContext {
    // ---------------------------------------------------------------
    // Member methods.
    //
    ...
    public static abstract class SelectionCADToolState extends statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addPoint(SelectionCADToolContext context, double pointX,
	...
	private static final class Selection_FirstPoint extends
	    ...
	    @Override
	    protected void addPoint(SelectionCADToolContext context,
