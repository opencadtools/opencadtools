...
public final class InternalPolygonCADToolContext extends statemap.FSMContext {
    // ---------------------------------------------------------------
    // Member methods.
    //
    ...
    public static abstract class InternalPolygonCADToolState extends
	    statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addPoint(InternalPolygonCADToolContext context,
	...
	protected void endPoint(InternalPolygonCADToolContext context,
		double pointX, double pointY, InputEvent event) {
	    Default(context);
	}
	...
	static {
	    AddNextPoint = new InternalPolygon_Default.InternalPolygon_AddNextPoint(
		    "InternalPolygon.AddNextPoint", 0);
	    Default = new InternalPolygon_Default("InternalPolygon.Default", -1);
	}

    }

    protected static class InternalPolygon_Default extends
	    InternalPolygonCADToolState {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addOption(InternalPolygonCADToolContext context, String s) {
		...
		boolean loopbackFlag = context.getState().getName()
			.equals(InternalPolygon.AddNextPoint.getName());
	...
	protected void endPoint(InternalPolygonCADToolContext context,
		...
		ctxt.addOption(PluginServices.getText(this,
	...
	private static final class InternalPolygon_AddNextPoint extends
		InternalPolygon_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
	    ...
	    @Override
	    protected void addOption(InternalPolygonCADToolContext context,
		    String s) {
		InternalPolygonCADTool ctxt = context.getOwner();
