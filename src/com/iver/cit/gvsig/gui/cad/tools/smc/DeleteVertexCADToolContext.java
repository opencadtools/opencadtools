 ...
 */
public final class DeleteVertexCADToolContext extends statemap.FSMContext {
    // ---------------------------------------------------------------
    // Member methods.
    //
    ...
    public static abstract class DeleteVertexCADToolState extends
	    statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addPoint(DeleteVertexCADToolContext context,
	...
	static {
	    SelectVertexOrDelete = new DeleteVertex_Default.DeleteVertex_SelectVertexOrDelete(
		    "DeleteVertex.SelectVertexOrDelete", 0);
	    Default = new DeleteVertex_Default("DeleteVertex.Default", -1);
	}

    }

    protected static class DeleteVertex_Default extends
	    DeleteVertexCADToolState {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addOption(DeleteVertexCADToolContext context, String s) {
	    ...
	    boolean loopbackFlag = context.getState().getName()
		    .equals(DeleteVertex.SelectVertexOrDelete.getName());
	...
	private static final class DeleteVertex_SelectVertexOrDelete extends
		DeleteVertex_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
