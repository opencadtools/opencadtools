...
public final class ComplexSelectionCADToolContext extends statemap.FSMContext {
    // ---------------------------------------------------------------
    // Member methods.
    //
    ...
    public static abstract class ComplexSelectionCADToolState extends
	    statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addOption(ComplexSelectionCADToolContext context,
		String s) {
	    Default(context);
	}

	protected void addPoint(ComplexSelectionCADToolContext context,
	...
	static {
	    FirstPoint = new Selection_Default.Selection_FirstPoint(
		    "Selection.FirstPoint", 0);
	    SecondPoint = new Selection_Default.Selection_SecondPoint(
		    "Selection.SecondPoint", 1);
	    WithSelectedFeatures = new Selection_Default.Selection_WithSelectedFeatures(
		    "Selection.WithSelectedFeatures", 2);
	    WithHandlers = new Selection_Default.Selection_WithHandlers(
		    "Selection.WithHandlers", 3);
	    SecondPointOutRectangle = new Selection_Default.Selection_SecondPointOutRectangle(
		    "Selection.SecondPointOutRectangle", 4);
	    SecondPointCircle = new Selection_Default.Selection_SecondPointCircle(
		    "Selection.SecondPointCircle", 5);
	    NextPointPolygon = new Selection_Default.Selection_NextPointPolygon(
		    "Selection.NextPointPolygon", 6);
	    Default = new Selection_Default("Selection.Default", -1);
	}

    }

    protected static class Selection_Default extends
	    ComplexSelectionCADToolState {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addOption(ComplexSelectionCADToolContext context,
		...
		boolean loopbackFlag = context.getState().getName()
			.equals(Selection.FirstPoint.getName());
	...
	private static final class Selection_FirstPoint extends
		Selection_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
		...
		ctxt.setDescription(new String[] { "out_rectangle",
			"inside_polygon", "cross_polygon", "out_polygon",
			"inside_circle", "cross_circle", "out_circle",
			"select_all", "cancel" });
		return;
	    }
		...
		if (ctxt.getType().equals(
			...
			ctxt.setDescription(new String[] { "out_rectangle",
				"inside_polygon", "cross_polygon",
				"out_polygon", "inside_circle", "cross_circle",
				"out_circle", "select_all", "cancel" });
			...
			ctxt.setDescription(new String[] { "end_polygon",
				"out_rectangle", "inside_polygon",
				"cross_polygon", "out_polygon",
				"inside_circle", "cross_circle", "out_circle",
				"select_all", "cancel" });
			ctxt.addPoint(pointX, pointY, event);
		    } finally {
			...
			&& ctxt.getNextState().equals("Selection.SecondPoint")) {
	...
	private static final class Selection_SecondPoint extends
		Selection_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
		...
		try {
		    ctxt.setQuestion(PluginServices.getText(this,
			    ...
			    + PluginServices.getText(this,
				    "ComplexSelectionCADTool.outcircle") + "]");
		    ctxt.setDescription(new String[] { "end_polygon",
			    "out_rectangle", "inside_polygon", "cross_polygon",
			    "out_polygon", "inside_circle", "cross_circle",
			    "out_circle", "select_all", "cancel" });
		    ctxt.setType(s);
		} finally {
	...
	private static final class Selection_WithSelectedFeatures extends
		Selection_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
		...
		if (ctxt.selectHandlers(pointX, pointY, event) > 0) {
			...
			&& ctxt.getNextState().equals(
				"Selection.WithSelectedFeatures")) {
		    ComplexSelectionCADToolState endState = context.getState();
	...
	private static final class Selection_WithHandlers extends
		Selection_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
	...
	private static final class Selection_SecondPointOutRectangle extends
		Selection_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
		...
		if (ctxt.selectWithSecondPointOutRectangle(pointX, pointY,
			event) > 0) {
	...
	private static final class Selection_SecondPointCircle extends
		Selection_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
	...
	private static final class Selection_NextPointPolygon extends
		Selection_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
