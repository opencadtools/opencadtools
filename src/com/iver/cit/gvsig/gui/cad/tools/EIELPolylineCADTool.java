...
public class EIELPolylineCADTool extends InsertionCADTool {
    private static Logger logger = Logger.getLogger(EIELPolylineCADTool.class
	    .getName());
	...
	EIELPolylineCADToolState actualState = (EIELPolylineCADToolState) _fsm
		.getPreviousState();
	...
	EIELPolylineCADToolState actualState = ((EIELPolylineCADToolContext) _fsm)
		.getState();
	String status = actualState.getName();
