...
public final class CircleCADToolContext extends statemap.FSMContext {
    ...
    public static abstract class CircleCADToolState extends statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	static {
	    CenterPointOr3p = new Circle_Default.Circle_CenterPointOr3p(
		    "Circle.CenterPointOr3p", 0);
	    PointOrRadius = new Circle_Default.Circle_PointOrRadius(
		    "Circle.PointOrRadius", 1);
	    SecondPoint = new Circle_Default.Circle_SecondPoint(
		    "Circle.SecondPoint", 2);
	    ThirdPoint = new Circle_Default.Circle_ThirdPoint(
		    "Circle.ThirdPoint", 3);
	    FirstPoint = new Circle_Default.Circle_FirstPoint(
		    "Circle.FirstPoint", 4);
	...
	private static final class Circle_CenterPointOr3p extends
		Circle_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
