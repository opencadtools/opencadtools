...
public final class EquidistanceCADToolContext extends statemap.FSMContext {
    // ---------------------------------------------------------------
    // Member methods.
    //
    ...
    public static abstract class EquidistanceCADToolState extends
	    statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addPoint(EquidistanceCADToolContext context,
	...
	static {
	    Distance = new Equidistance_Default.Equidistance_Distance(
		    "Equidistance.Distance", 0);
	    SecondPointDistance = new Equidistance_Default.Equidistance_SecondPointDistance(
		    "Equidistance.SecondPointDistance", 1);
	    Position = new Equidistance_Default.Equidistance_Position(
		    "Equidistance.Position", 2);
	    Default = new Equidistance_Default("Equidistance.Default", -1);
	}

    }

    protected static class Equidistance_Default extends
	    EquidistanceCADToolState {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addOption(EquidistanceCADToolContext context, String s) {
		...
		boolean loopbackFlag = context.getState().getName()
			.equals(Equidistance.Distance.getName());
	...
	private static final class Equidistance_Distance extends
		Equidistance_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
	...
	private static final class Equidistance_SecondPointDistance extends
		Equidistance_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
	...
	private static final class Equidistance_Position extends
		Equidistance_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
