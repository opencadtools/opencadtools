...
public final class RotateCADToolContext extends statemap.FSMContext {
    // ---------------------------------------------------------------
    // Member methods.
    //
    ...
    public static abstract class RotateCADToolState extends statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addPoint(RotateCADToolContext context, double pointX,
	...
	static {
	    PointMain = new Rotate_Default.Rotate_PointMain("Rotate.PointMain",
		    0);
	    AngleOrPoint = new Rotate_Default.Rotate_AngleOrPoint(
		    "Rotate.AngleOrPoint", 1);
	...
	protected void addOption(RotateCADToolContext context, String s) {
		...
		boolean loopbackFlag = context.getState().getName()
			.equals(Rotate.PointMain.getName());
	...
	private static final class Rotate_PointMain extends Rotate_Default {
	    ...
	    @Override
	    protected void addPoint(RotateCADToolContext context,
