 ...
 */
public final class InsertVertexCADToolContext extends statemap.FSMContext {
    // ---------------------------------------------------------------
    // Member methods.
    //
    ...
    public static abstract class InsertVertexCADToolState extends
	    statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addPoint(InsertVertexCADToolContext context,
	...
	static {
	    SelectVertexOrDelete = new InsertVertex_Default.InsertVertex_SelectVertexOrDelete(
		    "InsertVertex.SelectVertexOrDelete", 0);
	    Default = new InsertVertex_Default("InsertVertex.Default", -1);
	}

    }

    protected static class InsertVertex_Default extends
	    InsertVertexCADToolState {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addOption(InsertVertexCADToolContext context, String s) {
	    ...
	    boolean loopbackFlag = context.getState().getName()
		    .equals(InsertVertex.SelectVertexOrDelete.getName());
	...
	private static final class InsertVertex_SelectVertexOrDelete extends
		InsertVertex_Default {
	    // -------------------------------------------------------
	    // Member methods.
	    //
