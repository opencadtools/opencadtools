...
public class ComplexSelectionCADTool extends SelectionCADTool {
     ...
     */
    public int selectWithSecondPointOutRectangle(double x, double y,
	    InputEvent event) {
	...
	IGeometry circle = ShapeFactory.createCircle(firstPoint,
	...
	if (status.equals("Selection.SecondPointCircle")) {
	    ...
	    circleSel.draw((Graphics2D) g, vp,
		    DefaultCADTool.geometrySelectSymbol);
	    Image img = vle.getSelectionImage();
	    g.drawImage(img, 0, 0, null);
	    return;
