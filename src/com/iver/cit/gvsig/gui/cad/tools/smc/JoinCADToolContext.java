...
public final class JoinCADToolContext extends statemap.FSMContext {
    ...
    public static abstract class JoinCADToolState extends statemap.State {
	// -----------------------------------------------------------
	// Member methods.
	//
	...
	protected void addPoint(JoinCADToolContext context, double pointX,
