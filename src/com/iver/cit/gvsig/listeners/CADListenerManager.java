...
public class CADListenerManager {
	...
	private static HashMap<String, EndGeometryListener> endGeometryListeners =
		new HashMap<String, EndGeometryListener>();

	public static void addEndGeometryListener(String key, EndGeometryListener lis) {
