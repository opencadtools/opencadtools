...
//import com.iver.cit.gvsig.gui.cad.snapping.AbstractSnapper;
//import com.iver.cit.gvsig.gui.cad.snapping.ISnapperVectorial;

//import es.udc.lbd.eiel.gui.cad.tools.SelectionCADTool;
 ...
 *
 */
public class EIELNearestPointSnapper extends AbstractSnapper implements ISnapperVectorial {
	...
	/**
	 * Devuelve el punto, dentro de las aristas la geometría 'geom', más proximo al punto 'point'
	 * siempre que la cercanía sea menor o igual a la toleracia 'tolerance'.
...
//		aqui almacenaremos los indices del ultimo punto encontrado y del punto mas pequeño que forme
...
//		añado esto para ver si consigo tratar de forma coherente las multigeometrias
...
//						metemos primero esto por si añade un nuevo punto
						...
						if((cUltimo.distance(ultimoPuntoCercano)<UMBRAL_CERCANIA)&&(!cUltimo.equals(from))){
...
//					le ponemos el indice como un numero mas ya que añadiremos luego el punto
