...
public class TableLayers extends JPanel {
    private ImageIcon selected = PluginServices.getIconTheme().get(
	    "images-selected-icon");
    private ImageIcon notselected = PluginServices.getIconTheme().get(
	    "images-notselected-icon");
    private ImageIcon blocked = PluginServices.getIconTheme().get(
	    "images-blocked-icon");
    private ImageIcon unblocked = PluginServices.getIconTheme().get(
	    "images-unblocked-icon");
    private ImageIcon active = PluginServices.getIconTheme().get(
	    "images-active-icon");
    private ImageIcon defuse = PluginServices.getIconTheme().get(
	    "images-defuse-icon");
    private ImageIcon disable = PluginServices.getIconTheme().get(
	    "images-disabled-icon");
    private ImageIcon notdisable = PluginServices.getIconTheme().get(
	    "images-notdisabled-icon");
    private ImageIcon fill = PluginServices.getIconTheme().get(
	    "images-fill-icon");
    private ImageIcon notfill = PluginServices.getIconTheme().get(
	    "images-notfill-icon");
	...
	PresentCellEditor presenteditor = new PresentCellEditor(eml, table,
	...
	ActivatedCellEditor activatededitor = new ActivatedCellEditor(eml,
		table, active, defuse);
	...
	DisabledCellEditor disablededitor = new DisabledCellEditor(eml, table,
		notdisable, disable);
	...
	BlockedCellEditor blockeditor = new BlockedCellEditor(eml, table,
		blocked, unblocked);
	...
	// private Object[][] data = {
	// {new Boolean(true), "Nombre1",new Boolean(true) ,new
	// Boolean(false),new Boolean(false),
	// "símbolo"},
	// {new Boolean(false), "Nombre2",new Boolean(true),new
	// Boolean(false),new Boolean(false),
	// "símbolo"},
	// {new Boolean(false), "Nombre3",new Boolean(true),new
	// Boolean(false),new Boolean(false),
	// "símbolo"},
	// {new Boolean(false), "Nombre4",new Boolean(true),new
	// Boolean(false),new Boolean(false),
	// "símbolo"},
	// {new Boolean(false), "Nombre5",new Boolean(true),new
	// Boolean(false),new Boolean(false),
	// "símbolo"}
	// };
	public final Object[] longValues = { new ImageIcon(), "Nombre1",
		new ImageIcon(), new ImageIcon(), new ImageIcon(),
		new ImageIcon(),
