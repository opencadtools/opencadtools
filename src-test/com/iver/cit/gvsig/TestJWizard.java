 ...
 * 
 * <br>
 * To receive a copy of the GNU Lesser General Public License <br>
 * write to: The Free Software Foundation, Inc., <br>
...
public class TestJWizard {
	...
	try {
	    ...
	    /*
	     * wizardFrame.getWizardComponents().addWizardPanel( new
	     * SimpleLabelWizardPanel(wizardFrame.getWizardComponents(), new
	     * JLabel("Dynamic Test")));
	     */
	    /*
	     ...
	     * );
	     * 
	     * DriverManager writerManager = LayerFactory.getDM(); ArrayList
	     * spatialDrivers = new ArrayList(); String[] writerNames =
	     * writerManager.getDriverNames(); for (int i=0;
	     * i<writerNames.length; i++) { Driver drv =
	     * writerManager.getDriver(writerNames[i]); if (drv instanceof
	     * ISpatialWriter) spatialDrivers.add(drv.getName()); }
	     * 
	     * 
	     * 
	     * wizardFrame.getWizardComponents().addWizardPanel( new
	     * ChooseWriteDriver(wizardFrame.getWizardComponents(),
	     * "Dynamic Test", (String[]) spatialDrivers.toArray(new
	     * String[0])));
	     */
